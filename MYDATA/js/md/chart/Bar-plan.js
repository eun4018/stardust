        ...
        <div class="chartGroup">
          ...
          <ul class="y-area" aria-label="Y축 범위">
            <li 
              ...
              :key="item.id">
              <span class="y">{{item.name}}<em class="blind">만원</em></span>
              <div v-show="yLength(index)" class="unit">만원</div>
            </li>
          </ul>
      ...
      data: function () {
        return {
          ...
          a11y: [
            {
              "id": "CON-003-0001-1",
              "title": "최근 6개월 카드 사용금액",
              "desc": "최근 6개월간 카드 사용 금액 정보"
            },
            {
              "id": "CON-003-0001-2",
              "title": "최근 6개월 카드 사용금액",
            ...
            },
            {
              "id": "CON-001-0001-0",
              "title": "지난 3개월 지출금액",
              "desc": "지난 3개월 기준 월별 지출금액 정보"
            },
            {
              "id": "CON-003-0003-1",
              "title": "할부금액",
              "desc": "향후 6개월간 남은 할부 정보"
            },
            {
              "id": "CON-003-0003-2",
              "title": "할부금액",
